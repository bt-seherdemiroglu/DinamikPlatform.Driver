...
N6 G53";
        ...
        private void trackBarNumberofTilt_Scroll(object sender, EventArgs e)
        {
            numberOfDirection = trackBarNumberofTilt.Value;
            labelNumberofTilt.Text = trackBarNumberofTilt.Value.ToString();
        }
        ...
        public void generateGCode()
        {
            ...
            angleIncrease = 360 / numberOfDirection;
            ...
            if (radioBtnClockwise.Checked==true | randomValue==1)
            {
                ...
                while(i<numberOfDirection)
                {
                    ...
                    double[] axis2 = { 0, 0, 0, 0, 0, 0 };
                    ikControlList.Add(axis2);
                    angle = angle + angleIncrease;
                    i=i+1;
                } 

            }
            if(radioBtnCounterclocwise.Checked==true | randomValue==2)
            {
                double angle = 90;
                int i = 0;
                while (i < numberOfDirection)
